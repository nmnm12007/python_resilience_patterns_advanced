...
# from resilience_full_impl.executor.resilience_executor import ResilienceExecutor, TimeoutException
...
#     cb_policy = CircuitBreakerPolicy(3,2)
#
#     executor = ResilienceExecutor(retry,cb_policy=cb_policy)
#     try:
#         executor.execute_with_retry_and_timeout(slow_function, timeout_policy)
#         print("ERROR: should have timed out")
#     except (TimeoutException, CancelledException):
